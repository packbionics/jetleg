...
exec(open("/home/anthony/packbionics-ws/src/jetleg/jetleg_control/docs_build/jetleg_control/jetleg_control/default_sphinx_project/conf.py").read())
...
ensure_global('project', "jetleg_control")
ensure_global('author', """jasonx""")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['sensor_msgs', 'geometry_msgs', 'jetleg_interfaces', 'rcl_interfaces', 'generate_parameter_library']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/anthony/packbionics-ws/src/jetleg/jetleg_control/docs_build/jetleg_control/jetleg_control/wrapped_sphinx_directory/generated",
