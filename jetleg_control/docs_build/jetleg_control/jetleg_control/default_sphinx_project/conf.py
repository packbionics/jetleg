...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/anthony/packbionics-ws/src/jetleg/jetleg_control/jetleg_control', '..')))
...
copyright = 'The <jetleg_control> Contributors. License: Apache License 2.0'
author = """jasonx"""
