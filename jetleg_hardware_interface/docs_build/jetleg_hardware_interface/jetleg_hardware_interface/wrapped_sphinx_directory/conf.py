...
exec(open("/home/anthony/packbionics-ws/src/jetleg/jetleg_hardware_interface/docs_build/jetleg_hardware_interface/jetleg_hardware_interface/default_sphinx_project/conf.py").read())
...
ensure_global('project', "jetleg_hardware_interface")
ensure_global('author', """anthony""")
ensure_global('release', "0.0.1")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['hardware_interface', 'pluginlib', 'rclcpp', 'rclcpp_lifecycle', 'joint_state_broadcaster', 'joint_trajectory_controller', 'forward_command_controller']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "jetleg_hardware_interface Doxygen Project": "/home/anthony/packbionics-ws/src/jetleg/jetleg_hardware_interface/docs_build/jetleg_hardware_interface/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/anthony/packbionics-ws/src/jetleg/jetleg_hardware_interface/docs_build/jetleg_hardware_interface/jetleg_hardware_interface/wrapped_sphinx_directory/generated",
