...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/anthony/packbionics-ws/src/jetleg/jetleg_hardware_interface/jetleg_hardware_interface', '..')))
...
copyright = 'The <jetleg_hardware_interface> Contributors. License: MIT'
author = """anthony"""
