...
def generate_launch_description():
  ...
  urdf_file_path = 'urdf/jetleg_wheeled_testrig.xacro'

  world_package_name = 'two_wheeled_robot'
  ...
  world_path = os.path.join(FindPackageShare(package=world_package_name).find(world_package_name), world_file_path)
