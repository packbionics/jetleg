...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/anthony/packbionics-ws/src/jetleg/jetleg_vision/jetleg_vision', '..')))
...
copyright = 'The <jetleg_vision> Contributors. License: MIT'
author = """jasonx"""
