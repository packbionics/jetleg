...
exec(open("/home/anthony/packbionics-ws/src/jetleg/jetleg_vision/docs_build/jetleg_vision/jetleg_vision/default_sphinx_project/conf.py").read())
...
ensure_global('project', "jetleg_vision")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['ros2launch', 'tf2_ros', 'cv_bridge', 'rclcpp', 'rclpy']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/anthony/packbionics-ws/src/jetleg/jetleg_vision/docs_build/jetleg_vision/jetleg_vision/wrapped_sphinx_directory/generated",
